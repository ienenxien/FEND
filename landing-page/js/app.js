...
const killActive = (sect) => {
    ...
    navigation.classList.remove('active__link');
    navigation.style.cssText = "background-color: linear-gradient(0deg, rgba(255,255,255,.1) 0%, rgba(255,255,255,.2) 100%)";
};
...
const active = (cond, sect) => {
    if(cond){
        ...
        navigation.classList.add('active__link');
        navigation.style.cssText = "background-color: blue;";
    };
};
